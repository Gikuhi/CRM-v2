...
export default function SystemWideCallMonitoringPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold">Team Call Monitoring</h1>
      <Card>
        <CardHeader>
          <CardTitle>Live Call View</CardTitle>
          <CardDescription>Real-time view of your team's active calls.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
