            ...
            <Card className="bg-card">
                 <CardHeader>
                    <div className="flex justify-between items-center">
                        ...
                        <Button onClick={() => setCallAccepted(true)} className="bg-accent text-accent-foreground hover:bg-accent/90">ACCEPT</Button>
                    </div>
                </CardHeader>
                <CardContent className="text-center p-8">
                    <p className="text-xl font-semibold text-accent">RICHARD MUSYOKA</p>
                    <p className="text-muted-foreground">LendPlus Account</p>
                    <p className="text-lg font-bold text-foreground mt-4">Today's Balance:</p>
                    <p className="text-3xl font-bold text-accent">Ksh XX,XXX</p>
                </CardContent>
            </Card>
        ) : (
             <Card className="bg-card text-foreground">
                ...
                <div className="flex justify-between items-start mb-4">
                    <div>
                    <h2 className="text-2xl font-bold text-accent">RICHARD MUSYOKA</h2>
                    <p className="text-muted-foreground">LendPlus Account</p>
                    <p className="mt-2">
                ...
                <div className="relative my-4">
                    <Button variant="outline" className="bg-accent text-accent-foreground border-accent hover:bg-accent/90 absolute -left-4 top-1/2 -translate-y-1/2 z-10" style={{ clipPath: 'polygon(0% 0%, 85% 0%, 100% 50%, 85% 100%, 0% 100%)' }}>
                        Lost RPC had PTP
                    </Button>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    {/* Gather Intelligence */}
                    <div className="p-4 border rounded-lg bg-secondary/30">
                        <h3 className="font-semibold text-accent mb-2">Gather Intelligence: Customer Information</h3>
                        <div className="text-sm space-y-1 text-muted-foreground">
                        <p>Total Brokens: 1</p>
                    ...
                    {/* Making the offer */}
                    <div className="p-4 border rounded-lg bg-secondary/30">
                        <h3 className="font-semibold text-accent mb-2">Making the offer and closing the deal:</h3>
                        <div className="text-sm space-y-1 text-muted-foreground">
