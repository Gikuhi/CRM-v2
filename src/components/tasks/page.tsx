                  ...
                  <div className="grid gap-1">
                   ...
                   <Badge 
                    className={cn("ml-auto", {
                      'bg-accent-warning/20 text-accent-warning border-accent-warning/20': task.status === 'In Progress',
                      'bg-accent-success/20 text-accent-success border-accent-success/20': task.status === 'Completed',
                    })}
                    variant="outline"
                  >
                    {task.status}
