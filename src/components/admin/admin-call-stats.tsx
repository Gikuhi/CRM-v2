        ...
        <CardContent>
            ...
            {adminCallStats.map((stat) => (
                <div key={stat.period} className="p-4 border rounded-lg">
                    <h3 className="text-lg font-semibold text-primary mb-4">{stat.period}</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                        ...
                        <div className="p-4 bg-muted rounded-lg">
                            <PhoneIncoming className="h-6 w-6 text-accent-success mx-auto mb-2" />
                        ...
                        <div className="p-4 bg-muted rounded-lg">
                            <PhoneOff className="h-6 w-6 text-accent-danger mx-auto mb-2" />
