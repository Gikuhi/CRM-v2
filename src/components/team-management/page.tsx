              ...
              {teamMembers.map((member) => (
                <TableRow key={member.id}>
                  ...
                  <TableCell className="hidden sm:table-cell">
                     <Badge 
                        className={cn({
                            'bg-accent-success/20 text-accent-success border-accent-success/20': member.status === 'Online',
                            'bg-accent-danger/20 text-accent-danger border-accent-danger/20': member.status === 'Offline',
                            'bg-accent-warning/20 text-accent-warning border-accent-warning/20': member.status === 'On Call',
                        })}
                        variant="outline"
                    >
                        {member.status}
